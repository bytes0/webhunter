...
export default {
  ...
  errorCaptured(err, vm, info) {
    ...
    // Prevent the error from propagating and freezing the app
    return false
  },
  mounted() {
...
.btn-secondary {
  @apply px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed;
}
